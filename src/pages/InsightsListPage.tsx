                    ...
                    {uc === 'nrl' && (
                      ...
                      >
                        <div className="flex items-center gap-3 mb-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <h3 className="font-semibold text-gray-900 text-sm truncate">NRL Teams</h3>
                            <span className="inline-block mt-0.5 px-2 py-0.5 rounded-full text-xs font-medium bg-indigo-100 text-indigo-700">
                              Composite Analysis
                            </span>
                          </div>
                        ...
                        <p className="text-sm font-medium text-gray-700 mb-2">Team Dominance, Predictions & Coaching Insights</p>
                        <p className="text-xs text-gray-500 leading-relaxed mb-3 line-clamp-3">
                          All-time dominance rankings, match outcome predictions, tactical team profiles, head-to-head rivalry matrix, and 5-year rolling trend analysis across 35 years of NRL fixtures.
                        </p>
                        <div className="border-t border-gray-100 pt-2">
                          <p className="text-xs font-medium text-gray-500 mb-1">Key actions:</p>
                          <p className="text-xs text-gray-400 line-clamp-2">Compare team archetypes, identify coaching strengths/weaknesses, and track performance trajectories over time</p>
                        </div>
                      </button>
                    )}
                    {groupCards.map(c => {
